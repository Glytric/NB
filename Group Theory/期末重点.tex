...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{GP//GP1.png}
\end{figure}
正则杨表的个数由钩形数规则给出:
\begin{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{GP//GP2.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{GP//GP3.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{GP//GP4.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{GP//GP5.png}
\end{figure}
